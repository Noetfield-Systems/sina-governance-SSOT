...
permission to continue ordered work is itself an invented gate. Uncommitted work is
also fragile: parallel hygiene loops sweep the working tree, so ordered work must be
recorded immediately after verification.
