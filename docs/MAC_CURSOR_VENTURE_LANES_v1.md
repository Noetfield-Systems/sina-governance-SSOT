# Mac Cursor — venture lane map v1

**Purpose:** Open the correct Cursor workspace root per task. SG chat does not build venture repos.

| Lane | Cursor root | Owner | Next action |
|------|-------------|-------|-------------|
...
**Done:** B-04 TrustField Phase 1 registered (`brain_register_trustfield_loops_v1.py`).

**Rule:** Use Cursor `move_agent_to_root` when switching venture — do not edit TrustField from SG chat.
