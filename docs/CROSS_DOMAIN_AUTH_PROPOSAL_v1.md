...
**Status:** ACTIVE proposal · **Authority:** SG verifies; venture repos implement  
...
**Machine matrix:** `data/auth_surface_matrix_v1.json`  
...
| Asset | Path |
|-------|------|
| Surface matrix | `data/auth_surface_matrix_v1.json` |
