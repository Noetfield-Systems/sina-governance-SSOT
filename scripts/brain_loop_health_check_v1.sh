...
_check "registry validation" "$BRAIN_PYTHON" "$ROOT/scripts/validate_brain_domain_registry_v1.py"
_check "workflow health validation" "$BRAIN_PYTHON" "$ROOT/scripts/validate_brain_loop_health_v1.py"
