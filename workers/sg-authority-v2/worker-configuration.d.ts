/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 0c75dde16aeacd6c7fa5548b2543772f)
// Runtime types generated with workerd@1.20260714.1 2026-07-18 nodejs_compat
interface __BaseEnv_Env {
	RECEIPTS: KVNamespace;
	MODE: string;
	WEBHOOK_ENABLED: string;
	CHECK_RUN_PUBLISH_ENABLED: string;
	...
	POLICY_HASH: string;
	SCHEMA_HASH: string;
	SG_SIGNING_KEY_ID: string;
	GITHUB_WEBHOOK_SECRET: string;
	GITHUB_APP_PRIVATE_KEY: string;
	SG_SIGNING_PRIVATE_JWK: string;
	SG_SIGNING_PUBLIC_JWK: string;
	SG_SHADOW_INTERNAL_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "WEBHOOK_ENABLED" | "CHECK_RUN_PUBLISH_ENABLED" | "EXPECTED_APP_SLUG" | "EXPECTED_ORG" | "EXPECTED_APP_ID" | "EXPECTED_INSTALLATION_ID" | "ALLOWED_REPOSITORIES" | "EXPECTED_CHECK_NAME" | "WORKER_VERSION" | "EVALUATOR_HASH" | "POLICY_HASH" | "SCHEMA_HASH" | "SG_SIGNING_KEY_ID" | "GITHUB_WEBHOOK_SECRET" | "GITHUB_APP_PRIVATE_KEY" | "SG_SIGNING_PRIVATE_JWK" | "SG_SIGNING_PUBLIC_JWK" | "SG_SHADOW_INTERNAL_TOKEN">> {}
}
