...
0f. **Noetfield Runway product (LOCKED)** — `P10-PRODUCT-LAYERS/NF_NOETFIELD_RUNWAY_PRODUCT_LOCKED_v1.md` before selling Motor/governance; active order Video → Software Repair → Research; preserve Cursor Video build; Gateway ≠ Motor
