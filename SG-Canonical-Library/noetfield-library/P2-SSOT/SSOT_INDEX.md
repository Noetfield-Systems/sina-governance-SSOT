...
| **Founder LinkedIn voice** | `../P1-CANON/FOUNDER_LINKEDIN_PROFILE_LOCKED_v1.md` | P1 canonical public voice; machine `data/founder_linkedin_profile_v1_LOCKED.json`; all agents read before outbound/UX. |
