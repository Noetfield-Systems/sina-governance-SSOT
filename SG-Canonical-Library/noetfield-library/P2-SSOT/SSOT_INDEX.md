...
| **Executive mesh v1** | `../P0-FOUNDATION-SPINE/NF_EXECUTIVE_MESH_V1_LOCKED_v1.md` | `NF-EXECUTIVE-MESH-V1` SG_ACCEPTED; Role Pods recommend; Governor commits; Runway Goal Kernel executes webpage-repair slice; no LLM Authority. |
| **Executive control plane v0** | `../P0-FOUNDATION-SPINE/NF_EXECUTIVE_CONTROL_PLANE_V0_LOCKED_v1.md` | `NF-EXECUTIVE-CONTROL-PLANE-V0` SG_ACCEPTED; deterministic Governor · Next Action Compiler · GREEN/AMBER/RED; SourceA package; no LLM decision path; no CF in v0. |
| **Decision capacity** | `../P0-FOUNDATION-SPINE/NF_DECISION_CAPACITY_LOCKED_v1.md` | `NF-DECISION-CAPACITY-V1` SG_ACCEPTED; MISSING_DECISION_CAPACITY → Decision Capacity Proposal → policy candidate → Motor Learning Organ replay; FROZEN work; CREATE_OR_EXTEND_POLICY route. |
| **Governed work packet control** | `../P0-FOUNDATION-SPINE/NF_GOVERNED_WORK_PACKET_CONTROL_LOCKED_v1.md` | `NF-GOVERNED-WORK-PACKET-CONTROL-V1` SG_ACCEPTED; Goal Contract immutability; Human Tax; hard/soft breakers; terminals ACCEPTED_ARTIFACT / BOUNDED_FAILURE / RED_ZONE_DECISION_PACKET; SAME_PLAN_HASH resume ban; Motor Learning Organ for learning. |
